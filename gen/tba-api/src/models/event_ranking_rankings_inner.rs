...
impl EventRankingRankingsInner {
    pub fn new(matches_played: i32, qual_average: Option<i32>, extra_stats: Vec<f64>, sort_orders: Option<Vec<f64>>, record: models::WltRecord, rank: i32, dq: i32, team_key: String) -> EventRankingRankingsInner {
