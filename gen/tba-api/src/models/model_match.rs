...
impl Match {
    pub fn new(key: String, comp_level: CompLevel, set_number: i32, match_number: i32, alliances: models::MatchSimpleAlliances, winning_alliance: WinningAlliance, event_key: String, time: Option<i64>, actual_time: Option<i64>, predicted_time: Option<i64>, post_result_time: Option<i64>, score_breakdown: models::MatchScoreBreakdown, videos: Vec<models::MatchVideosInner>) -> Match {
        Match {
            key,
            comp_level,
            set_number,
